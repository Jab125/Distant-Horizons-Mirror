...
{
	public static ExecutorService genThreads = Executors.newFixedThreadPool(LodConfig.Client.AdvancedModOptions.Threading.numberOfWorldGenerationThreads, new ThreadFactoryBuilder().setNameFormat("Gen-Worker-Thread-%d").build());
	...
	public boolean doWork()
	{
		if (!threadStarted)
		{
			if (LodConfig.Client.WorldGenerator.distanceGenerationMode == DistanceGenerationMode.SERVER)
			{
...
//		}
	...
	public static void restartExecutorService()
	{
		...
		genThreads = Executors.newFixedThreadPool(LodConfig.Client.AdvancedModOptions.Threading.numberOfWorldGenerationThreads, new ThreadFactoryBuilder().setNameFormat("Gen-Worker-Thread-%d").build());
	}
